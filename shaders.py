...
def compile_program_geom(name) :
	return compile_program_from_file_geom(name+".vert",name+".geom",name+".frag")

def compile_program_from_file(vertex_file ,fragment_file ) :
	vsrc = open(vertex_file,"r")
	fsrc = open(fragment_file,"r")

	return compile_program_from_source(vsrc.read(),fsrc.read())

def compile_program_from_file_geom(vertex_file , geometry_file ,fragment_file ) :
	vsrc = open(vertex_file,"r")
